...
1. Ο ταμίας αναζητεί το λογαριασμό του πελάτη βάσει ΑΦΜ πελάτη.
2. Το σύστημα εμφανίζει τα στοιχεία των λογαριασμών του πελάτη (αριθμός, ονοματεπώνυμο/επωνυμία δικαιούχου).
